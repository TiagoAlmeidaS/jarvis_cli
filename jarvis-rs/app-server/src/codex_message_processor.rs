...
use chrono::Utc;
use jarvis_app_server_protocol::Account;
use jarvis_app_server_protocol::AccountLoginCompletedNotification;
use jarvis_app_server_protocol::AccountUpdatedNotification;
use jarvis_app_server_protocol::AddConversationListenerParams;
use jarvis_app_server_protocol::AddConversationSubscriptionResponse;
use jarvis_app_server_protocol::AppsListParams;
use jarvis_app_server_protocol::AppsListResponse;
use jarvis_app_server_protocol::ArchiveConversationParams;
use jarvis_app_server_protocol::ArchiveConversationResponse;
use jarvis_app_server_protocol::AskForApproval;
use jarvis_app_server_protocol::AuthMode;
use jarvis_app_server_protocol::AuthStatusChangeNotification;
use jarvis_app_server_protocol::CancelLoginAccountParams;
use jarvis_app_server_protocol::CancelLoginAccountResponse;
use jarvis_app_server_protocol::CancelLoginAccountStatus;
use jarvis_app_server_protocol::CancelLoginChatGptResponse;
use jarvis_app_server_protocol::ClientRequest;
use jarvis_app_server_protocol::CollaborationModeListParams;
use jarvis_app_server_protocol::CollaborationModeListResponse;
use jarvis_app_server_protocol::CommandExecParams;
use jarvis_app_server_protocol::ConversationGitInfo;
use jarvis_app_server_protocol::ConversationSummary;
use jarvis_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use jarvis_app_server_protocol::ExecOneOffCommandResponse;
use jarvis_app_server_protocol::FeedbackUploadParams;
use jarvis_app_server_protocol::FeedbackUploadResponse;
use jarvis_app_server_protocol::ForkConversationParams;
use jarvis_app_server_protocol::ForkConversationResponse;
use jarvis_app_server_protocol::FuzzyFileSearchParams;
use jarvis_app_server_protocol::FuzzyFileSearchResponse;
use jarvis_app_server_protocol::GetAccountParams;
use jarvis_app_server_protocol::GetAccountRateLimitsResponse;
use jarvis_app_server_protocol::GetAccountResponse;
use jarvis_app_server_protocol::GetAuthStatusParams;
use jarvis_app_server_protocol::GetAuthStatusResponse;
use jarvis_app_server_protocol::GetConversationSummaryParams;
use jarvis_app_server_protocol::GetConversationSummaryResponse;
use jarvis_app_server_protocol::GetUserAgentResponse;
use jarvis_app_server_protocol::GetUserSavedConfigResponse;
use jarvis_app_server_protocol::GitDiffToRemoteResponse;
use jarvis_app_server_protocol::GitInfo as ApiGitInfo;
use jarvis_app_server_protocol::InputItem as WireInputItem;
use jarvis_app_server_protocol::InterruptConversationParams;
use jarvis_app_server_protocol::JSONRPCErrorError;
use jarvis_app_server_protocol::ListConversationsParams;
use jarvis_app_server_protocol::ListConversationsResponse;
use jarvis_app_server_protocol::ListMcpServerStatusParams;
use jarvis_app_server_protocol::ListMcpServerStatusResponse;
use jarvis_app_server_protocol::LoginAccountParams;
use jarvis_app_server_protocol::LoginAccountResponse;
use jarvis_app_server_protocol::LoginApiKeyParams;
use jarvis_app_server_protocol::LoginApiKeyResponse;
use jarvis_app_server_protocol::LoginChatGptCompleteNotification;
use jarvis_app_server_protocol::LoginChatGptResponse;
use jarvis_app_server_protocol::LogoutAccountResponse;
use jarvis_app_server_protocol::LogoutChatGptResponse;
use jarvis_app_server_protocol::McpServerOauthLoginCompletedNotification;
use jarvis_app_server_protocol::McpServerOauthLoginParams;
use jarvis_app_server_protocol::McpServerOauthLoginResponse;
use jarvis_app_server_protocol::McpServerRefreshResponse;
use jarvis_app_server_protocol::McpServerStatus;
use jarvis_app_server_protocol::MockExperimentalMethodParams;
use jarvis_app_server_protocol::MockExperimentalMethodResponse;
use jarvis_app_server_protocol::ModelListParams;
use jarvis_app_server_protocol::ModelListResponse;
use jarvis_app_server_protocol::NewConversationParams;
use jarvis_app_server_protocol::NewConversationResponse;
use jarvis_app_server_protocol::RemoveConversationListenerParams;
use jarvis_app_server_protocol::RemoveConversationSubscriptionResponse;
use jarvis_app_server_protocol::RequestId;
use jarvis_app_server_protocol::ResumeConversationParams;
use jarvis_app_server_protocol::ResumeConversationResponse;
use jarvis_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use jarvis_app_server_protocol::ReviewStartParams;
use jarvis_app_server_protocol::ReviewStartResponse;
use jarvis_app_server_protocol::ReviewTarget as ApiReviewTarget;
use jarvis_app_server_protocol::SandboxMode;
use jarvis_app_server_protocol::SendUserMessageParams;
use jarvis_app_server_protocol::SendUserMessageResponse;
use jarvis_app_server_protocol::SendUserTurnParams;
use jarvis_app_server_protocol::SendUserTurnResponse;
use jarvis_app_server_protocol::ServerNotification;
use jarvis_app_server_protocol::SessionConfiguredNotification;
use jarvis_app_server_protocol::SetDefaultModelParams;
use jarvis_app_server_protocol::SetDefaultModelResponse;
use jarvis_app_server_protocol::SkillsConfigWriteParams;
use jarvis_app_server_protocol::SkillsConfigWriteResponse;
use jarvis_app_server_protocol::SkillsListParams;
use jarvis_app_server_protocol::SkillsListResponse;
use jarvis_app_server_protocol::SkillsRemoteReadParams;
use jarvis_app_server_protocol::SkillsRemoteReadResponse;
use jarvis_app_server_protocol::SkillsRemoteWriteParams;
use jarvis_app_server_protocol::SkillsRemoteWriteResponse;
use jarvis_app_server_protocol::Thread;
use jarvis_app_server_protocol::ThreadArchiveParams;
use jarvis_app_server_protocol::ThreadArchiveResponse;
use jarvis_app_server_protocol::ThreadCompactStartParams;
use jarvis_app_server_protocol::ThreadCompactStartResponse;
use jarvis_app_server_protocol::ThreadForkParams;
use jarvis_app_server_protocol::ThreadForkResponse;
use jarvis_app_server_protocol::ThreadItem;
use jarvis_app_server_protocol::ThreadListParams;
use jarvis_app_server_protocol::ThreadListResponse;
use jarvis_app_server_protocol::ThreadLoadedListParams;
use jarvis_app_server_protocol::ThreadLoadedListResponse;
use jarvis_app_server_protocol::ThreadReadParams;
use jarvis_app_server_protocol::ThreadReadResponse;
use jarvis_app_server_protocol::ThreadResumeParams;
use jarvis_app_server_protocol::ThreadResumeResponse;
use jarvis_app_server_protocol::ThreadRollbackParams;
use jarvis_app_server_protocol::ThreadSetNameParams;
use jarvis_app_server_protocol::ThreadSetNameResponse;
use jarvis_app_server_protocol::ThreadSortKey;
use jarvis_app_server_protocol::ThreadSourceKind;
use jarvis_app_server_protocol::ThreadStartParams;
use jarvis_app_server_protocol::ThreadStartResponse;
use jarvis_app_server_protocol::ThreadStartedNotification;
use jarvis_app_server_protocol::ThreadUnarchiveParams;
use jarvis_app_server_protocol::ThreadUnarchiveResponse;
use jarvis_app_server_protocol::Turn;
use jarvis_app_server_protocol::TurnError;
use jarvis_app_server_protocol::TurnInterruptParams;
use jarvis_app_server_protocol::TurnStartParams;
use jarvis_app_server_protocol::TurnStartResponse;
use jarvis_app_server_protocol::TurnStartedNotification;
use jarvis_app_server_protocol::TurnStatus;
use jarvis_app_server_protocol::UserInfoResponse;
use jarvis_app_server_protocol::UserInput as V2UserInput;
use jarvis_app_server_protocol::UserSavedConfig;
use jarvis_app_server_protocol::build_turns_from_event_msgs;
...
use jarvis_core::ThreadConfigSnapshot;
use jarvis_core::ThreadManager;
use jarvis_core::ThreadSortKey as CoreThreadSortKey;
use jarvis_core::auth::login_with_api_key;
use jarvis_core::auth::login_with_chatgpt_auth_tokens;
use jarvis_core::config::Config;
use jarvis_core::config::ConfigOverrides;
use jarvis_core::config::ConfigService;
use jarvis_core::config::edit::ConfigEdit;
use jarvis_core::config::edit::ConfigEditsBuilder;
use jarvis_core::config::types::McpServerTransportConfig;
use jarvis_core::config_loader::CloudRequirementsLoader;
use jarvis_core::default_client::get_codex_user_agent;
use jarvis_core::error::JarvisErr;
use jarvis_core::exec::ExecParams;
use jarvis_core::exec_env::create_env;
use jarvis_core::features::Feature;
use jarvis_core::find_archived_thread_path_by_id_str;
use jarvis_core::find_thread_path_by_id_str;
use jarvis_core::git_info::git_diff_to_remote;
use jarvis_core::mcp::collect_mcp_snapshot;
use jarvis_core::mcp::group_tools_by_server;
use jarvis_core::parse_cursor;
use jarvis_core::protocol::EventMsg;
use jarvis_core::protocol::Op;
use jarvis_core::protocol::ReviewDelivery as CoreReviewDelivery;
use jarvis_core::protocol::ReviewRequest;
use jarvis_core::protocol::ReviewTarget as CoreReviewTarget;
use jarvis_core::protocol::SessionConfiguredEvent;
use jarvis_core::read_head_for_summary;
use jarvis_core::read_session_meta_line;
use jarvis_core::rollout_date_parts;
use jarvis_core::sandboxing::SandboxPermissions;
use jarvis_core::skills::remote::download_remote_skill;
use jarvis_core::skills::remote::list_remote_skills;
#[cfg(feature = "state")]
use jarvis_core::state_db::get_state_db;
use jarvis_core::token_data::parse_id_token;
use jarvis_core::windows_sandbox::WindowsSandboxLevelExt;
use jarvis_feedback::CodexFeedback;
use jarvis_login::ServerOptions as LoginServerOptions;
...
use jarvis_protocol::config_types::WindowsSandboxLevel;
use jarvis_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use jarvis_protocol::items::TurnItem;
use jarvis_protocol::models::ResponseItem;
use jarvis_protocol::protocol::AgentStatus;
use jarvis_protocol::protocol::GitInfo as CoreGitInfo;
use jarvis_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use jarvis_protocol::protocol::McpServerRefreshConfig;
...
use jarvis_protocol::protocol::USER_MESSAGE_BEGIN;
use jarvis_protocol::user_input::UserInput as CoreInputItem;
use jarvis_rmcp_client::perform_oauth_login_return_url;
use jarvis_utils_json_to_toml::json_to_toml;
...
/// Handles JSON-RPC messages for Jarvis threads (and legacy conversation APIs).
pub(crate) struct CodexMessageProcessor {
    auth_manager: Arc<AuthManager>,
    thread_manager: Arc<ThreadManager>,
    outgoing: Arc<OutgoingMessageSender>,
    jarvislinux_sandbox_exe: Option<PathBuf>,
    config: Arc<Config>,
...
pub(crate) struct CodexMessageProcessorArgs {
    ...
    pub(crate) jarvislinux_sandbox_exe: Option<PathBuf>,
...
impl CodexMessageProcessor {
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<JarvisThread>), JSONRPCErrorError> {
    ...
    async fn load_latest_config(&self) -> Result<Config, JSONRPCErrorError> {
        jarvis_core::config::ConfigBuilder::default()
    ...
    fn review_request_from_target(
        ...
        let hint = jarvis_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn login_api_key_common(
        ...
        if matches!(
            ...
            Some(ForcedLoginMethod::Google)
        ) {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "API key login is disabled. Use Google login instead.".to_string(),
                data: None,
            });
        }
    ...
    async fn login_api_key_v2(&mut self, request_id: RequestId, params: LoginApiKeyParams) {
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = jarvis_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = jarvis_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn login_chatgpt_auth_tokens(
        ...
        if let Err(err) =
            login_with_chatgpt_auth_tokens(&self.config.jarvis_home, &id_token, &access_token)
        {
            let error = JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
    ...
    async fn get_account(&self, request_id: RequestId, params: GetAccountParams) {
        ...
        let account = match self.auth_manager.auth_cached() {
            Some(auth) => Some(match auth {
                JarvisAuth::ApiKey(_) => Account::ApiKey {},
                JarvisAuth::Chatgpt(_) | JarvisAuth::ChatgptAuthTokens(_) => {
    ...
    async fn fetch_account_rate_limits(&self) -> Result<CoreRateLimitSnapshot, JSONRPCErrorError> {
        let Some(auth) = self.auth_manager.auth().await else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "Jarvis account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch Jarvis rate limits: {err}"),
                data: None,
            })
    }

    async fn get_user_saved_config(&self, request_id: RequestId) {
        let service = ConfigService::new_with_defaults(self.config.jarvis_home.clone());
    ...
    async fn set_default_model(&self, request_id: RequestId, params: SetDefaultModelParams) {
        ...
        match ConfigEditsBuilder::new(&self.config.jarvis_home)
    ...
    async fn exec_one_off_command(&self, request_id: RequestId, params: CommandExecParams) {
        ...
        let jarvislinux_sandbox_exe = self.config.jarvis_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        let req_id = request_id;
        let sandbox_cwd = self.config.cwd.clone();

        tokio::spawn(async move {
            match jarvis_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &jarvislinux_sandbox_exe,
    ...
    async fn process_new_conversation(
        ...
        let typesafe_overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            jarvis_linux_sandbox_exe: self.jarvislinux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<jarvis_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(jarvis_app_server_protocol::AskForApproval::to_core),
    ...
    async fn thread_set_name(&self, request_id: RequestId, params: ThreadSetNameParams) {
        ...
        let Some(name) = jarvis_core::util::normalize_thread_name(&name) else {
    ...
    async fn thread_unarchive(&mut self, request_id: RequestId, params: ThreadUnarchiveParams) {
        ...
        let state_db_ctx: Option<()> = None;
        let archived_folder = self
            .config
            .jarvis_home
            .join(jarvis_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.jarvis_home.join(jarvis_core::SESSIONS_SUBDIR);
    ...
    async fn thread_read(&mut self, request_id: RequestId, params: ThreadReadParams) {
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.jarvis_home, &thread_uuid.to_string())
                .await
            {
            ...
            .await
        {
            ...
            Err(err) => {
                let (code, message) = match err {
                    JarvisErr::Io(_) | JarvisErr::Json(_) => (
                        INVALID_REQUEST_ERROR_CODE,
                        format!("failed to load rollout `{}`: {err}", rollout_path.display()),
                    ),
                    JarvisErr::InvalidRequest(message) => (INVALID_REQUEST_ERROR_CODE, message),
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.jarvis_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
    ...
    async fn handle_resume_conversation(
        ...
        let thread_history = if let Some(path) = path {
            ...
            match find_thread_path_by_id_str(&self.config.jarvis_home, &conversation_id.to_string())
                .await
            {
                Ok(Some(found_path)) => {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.jarvis_home.join(jarvis_core::SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: RequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(jarvis_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn skills_remote_read(&self, request_id: RequestId, _params: SkillsRemoteReadParams) {
        match list_remote_skills(&self.config).await {
            Ok(skills) => {
                let data = skills
                    .into_iter()
                    .map(|skill| jarvis_app_server_protocol::RemoteSkillSummary {
                        id: skill.id,
                        name: skill.name,
    ...
    async fn skills_config_write(&self, request_id: RequestId, params: SkillsConfigWriteParams) {
        ...
        let result = ConfigEditsBuilder::new(&self.config.jarvis_home)
            .with_edits(edits)
            .apply()
            .await;
    ...
    async fn start_inline_review(
        &self,
        request_id: &RequestId,
        parent_thread: Arc<JarvisThread>,
    ...
    async fn start_detached_review(
        ...
        let rollout_path =
            find_thread_path_by_id_str(&self.config.jarvis_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
                    ...
                    event = conversation.next_event() => {
                        ...
                        outgoing_for_task
                            .send_notification(OutgoingNotification {
                                method: format!("Jarvis/event/{event_formatted}"),
...
fn skills_to_info(
    skills: &[jarvis_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<jarvis_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path);
            jarvis_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    jarvis_app_server_protocol::SkillInterface {
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    jarvis_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| jarvis_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn errors_to_info(
    errors: &[jarvis_core::skills::SkillError],
) -> Vec<jarvis_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| jarvis_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(
    ...
    for tool in tools {
        ...
        if let Err(err) = jarvis_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
pub(crate) async fn read_event_msgs_from_rollout(
    path: &Path,
) -> std::io::Result<Vec<jarvis_protocol::protocol::EventMsg>> {
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match jarvis_core::parse_turn_item(&item) {
...
mod tests {
    ...
    async fn read_summary_from_rollout_returns_empty_preview_when_no_user_message() -> Result<()> {
        use jarvis_protocol::protocol::RolloutItem;
        use jarvis_protocol::protocol::RolloutLine;
        use jarvis_protocol::protocol::SessionMetaLine;
        use std::fs;
        use std::fs::FileTimes;
