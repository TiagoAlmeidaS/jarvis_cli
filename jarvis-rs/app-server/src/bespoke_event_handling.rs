...
use crate::jarvismessage_processor::TurnSummaryStore;
...
use jarvis_app_server_protocol::CommandAction as V2ParsedCommand;
use jarvis_app_server_protocol::CommandExecutionApprovalDecision;
use jarvis_app_server_protocol::CommandExecutionOutputDeltaNotification;
...
use jarvis_app_server_protocol::CommandExecutionStatus;
use jarvis_app_server_protocol::ContextCompactedNotification;
use jarvis_app_server_protocol::DeprecationNoticeNotification;
use jarvis_app_server_protocol::DynamicToolCallParams;
use jarvis_app_server_protocol::ErrorNotification;
use jarvis_app_server_protocol::ExecCommandApprovalParams;
use jarvis_app_server_protocol::ExecCommandApprovalResponse;
use jarvis_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use jarvis_app_server_protocol::FileChangeApprovalDecision;
use jarvis_app_server_protocol::FileChangeOutputDeltaNotification;
...
use jarvis_app_server_protocol::FileUpdateChange;
use jarvis_app_server_protocol::InterruptConversationResponse;
...
use jarvis_app_server_protocol::PatchApplyStatus;
use jarvis_app_server_protocol::PatchChangeKind as V2PatchChangeKind;
use jarvis_app_server_protocol::PlanDeltaNotification;
use jarvis_app_server_protocol::RawResponseItemCompletedNotification;
use jarvis_app_server_protocol::ReasoningSummaryPartAddedNotification;
use jarvis_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use jarvis_app_server_protocol::ReasoningTextDeltaNotification;
use jarvis_app_server_protocol::ServerNotification;
use jarvis_app_server_protocol::ServerRequestPayload;
use jarvis_app_server_protocol::TerminalInteractionNotification;
use jarvis_app_server_protocol::ThreadItem;
use jarvis_app_server_protocol::ThreadNameUpdatedNotification;
use jarvis_app_server_protocol::ThreadRollbackResponse;
use jarvis_app_server_protocol::ThreadTokenUsage;
use jarvis_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use jarvis_app_server_protocol::ToolRequestUserInputOption;
use jarvis_app_server_protocol::ToolRequestUserInputParams;
use jarvis_app_server_protocol::ToolRequestUserInputQuestion;
use jarvis_app_server_protocol::ToolRequestUserInputResponse;
use jarvis_app_server_protocol::Turn;
use jarvis_app_server_protocol::TurnCompletedNotification;
use jarvis_app_server_protocol::TurnDiffUpdatedNotification;
use jarvis_app_server_protocol::TurnError;
use jarvis_app_server_protocol::TurnInterruptResponse;
use jarvis_app_server_protocol::TurnPlanStep;
use jarvis_app_server_protocol::TurnPlanUpdatedNotification;
...
use jarvis_core::protocol::TokenCountEvent;
use jarvis_core::protocol::TurnDiffEvent;
use jarvis_core::review_format::format_review_findings_block;
use jarvis_core::review_prompts;
use jarvis_protocol::ThreadId;
use jarvis_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use jarvis_protocol::plan_tool::UpdatePlanArgs;
use jarvis_protocol::protocol::ReviewOutputEvent;
use jarvis_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use jarvis_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    match msg {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let jarvis_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
        ...
        EventMsg::Error(ev) => {
            ...
            let jarviserror_info = ev.jarvis_error_info.clone();
            ...
            let turn_error = TurnError {
                message: ev.message,
                jarvis_error_info: ev.jarvis_error_info.map(V2CodexErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: jarvis_protocol::models::ResponseItem,
    outgoing: &OutgoingMessageSender,
) {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                jarviserror_info: Some(V2CodexErrorInfo::InternalServerError),
                additional_details: None,
            },
            &turn_summary_store,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                jarviserror_info: Some(V2CodexErrorInfo::Other),
                additional_details: None,
            },
            &turn_summary_store,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                jarviserror_info: Some(V2CodexErrorInfo::BadRequest),
                additional_details: None,
            },
            &turn_summary_store,
        )
