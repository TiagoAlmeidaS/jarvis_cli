...
use jarvis_core::protocol::CollabAgentInteractionBeginEvent;
use jarvis_core::protocol::CollabAgentInteractionEndEvent;
use jarvis_core::protocol::CollabAgentSpawnBeginEvent;
use jarvis_core::protocol::CollabAgentSpawnEndEvent;
use jarvis_core::protocol::CollabCloseBeginEvent;
use jarvis_core::protocol::CollabCloseEndEvent;
use jarvis_core::protocol::CollabWaitingBeginEvent;
...
use jarvis_core::protocol::ItemCompletedEvent;
...
use jarvis_core::web_search::web_search_detail;
use jarvis_protocol::items::TurnItem;
use jarvis_protocol::num_format::format_with_separators;
...
use jarvis_common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<jarvis_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(
            self,
            "OpenAI Jarvis v{} (research preview)\n--------",
            VERSION
        );
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    jarvis_core::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    jarvis_core::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    jarvis_core::protocol::McpStartupStatus::Cancelled => "cancelled".to_string(),
                    jarvis_core::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "Jarvis".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "Jarvis session".style(self.magenta).style(self.bold),
...
fn format_receiver_list(ids: &[jarvis_protocol::ThreadId]) -> String {
    if ids.is_empty() {
