...
use jarvis_core::protocol::AgentStatus as CoreAgentStatus;
...
pub struct EventProcessorWithJsonOutput {
    ...
    last_total_token_usage: Option<jarvis_core::protocol::TokenUsage>,
    ...
    pub fn collect_thread_events(&mut self, event: &protocol::Event) -> Vec<ThreadEvent> {
        match &event.msg {
            ...
            protocol::EventMsg::ItemCompleted(protocol::ItemCompletedEvent {
                item: jarvis_protocol::items::TurnItem::Plan(item),
                ..
            }) => {
