...
use jarvis_core::protocol::CollabAgentSpawnBeginEvent;
use jarvis_core::protocol::CollabAgentSpawnEndEvent;
use jarvis_core::protocol::CollabWaitingEndEvent;
...
use jarvis_core::protocol::PatchApplyEndEvent;
...
use jarvis_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use jarvis_exec::exec_events::AgentMessageItem;
use jarvis_exec::exec_events::CollabAgentState;
use jarvis_exec::exec_events::CollabAgentStatus;
use jarvis_exec::exec_events::CollabTool;
use jarvis_exec::exec_events::CollabToolCallItem;
use jarvis_exec::exec_events::CollabToolCallStatus;
use jarvis_exec::exec_events::CommandExecutionItem;
use jarvis_exec::exec_events::CommandExecutionStatus;
use jarvis_exec::exec_events::ErrorItem;
use jarvis_exec::exec_events::ItemCompletedEvent;
use jarvis_exec::exec_events::ItemStartedEvent;
use jarvis_exec::exec_events::ItemUpdatedEvent;
use jarvis_exec::exec_events::McpToolCallItem;
use jarvis_exec::exec_events::McpToolCallItemError;
use jarvis_exec::exec_events::McpToolCallItemResult;
use jarvis_exec::exec_events::McpToolCallStatus;
use jarvis_exec::exec_events::PatchApplyStatus;
use jarvis_exec::exec_events::PatchChangeKind;
use jarvis_exec::exec_events::ReasoningItem;
use jarvis_exec::exec_events::ThreadErrorEvent;
use jarvis_exec::exec_events::ThreadEvent;
use jarvis_exec::exec_events::ThreadItem;
use jarvis_exec::exec_events::ThreadItemDetails;
use jarvis_exec::exec_events::ThreadStartedEvent;
use jarvis_exec::exec_events::TodoItem as ExecTodoItem;
use jarvis_exec::exec_events::TodoListItem as ExecTodoListItem;
use jarvis_exec::exec_events::TurnCompletedEvent;
use jarvis_exec::exec_events::TurnFailedEvent;
use jarvis_exec::exec_events::TurnStartedEvent;
use jarvis_exec::exec_events::Usage;
use jarvis_exec::exec_events::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        jarvis_protocol::ThreadId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8").unwrap();
    ...
    let ev = event(
        ...
        EventMsg::SessionConfigured(SessionConfiguredEvent {
            ...
            forked_from_id: None,
            thread_name: None,
            model: "Jarvis-mini-latest".to_string(),
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TurnStarted(jarvis_core::protocol::TurnStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TurnComplete(jarvis_core::protocol::TurnCompleteEvent {
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(jarvis_core::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(jarvis_core::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = jarvis_core::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = jarvis_core::protocol::TokenUsageInfo {
    ...
    let token_count_event = event(
        "e1",
        EventMsg::TokenCount(jarvis_core::protocol::TokenCountEvent {
            info: Some(info),
            rate_limits: None,
        }),
    );
