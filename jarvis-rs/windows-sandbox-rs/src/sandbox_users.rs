...
use jarvis_windows_sandbox::dpapi_protect;
...
const SANDBOX_USERS_GROUP_COMMENT: &str = "Jarvis sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(jarvis_home);
    ...
    let secrets_dir = sandbox_secrets_dir(jarvis_home);
