...
pub use jarvis_core::connectors::AppInfo;
pub use jarvis_core::connectors::connector_display_label;
use jarvis_core::connectors::connector_install_url;
pub use jarvis_core::connectors::list_accessible_connectors_from_mcp_tools;
use jarvis_core::connectors::merge_connectors;
...
pub async fn list_all_connectors(config: &Config) -> anyhow::Result<Vec<AppInfo>> {
    ...
    init_chatgpt_token_from_auth(&config.jarvis_home, config.cli_auth_credentials_store_mode)
        .await?;
