...
impl MetricsConfig {
    ...
    ///
    /// Note: Prometheus export is typically done via OTLP to an OpenTelemetry Collector
    /// that converts to Prometheus format. This config option is for future direct Prometheus support.
    pub fn prometheus(
        environment: impl Into<String>,
        service_name: impl Into<String>,
        service_version: impl Into<String>,
