...
const RESOURCE_URI: &str = "memo://Jarvis/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    jarvis_utils_cargo_bin::cargo_bin("test_stdio_server")
}
...
fn init_params() -> InitializeRequestParam {
    InitializeRequestParam {
        ...
        client_info: Implementation {
            name: "Jarvis-test".into(),
            version: "0.0.0-test".into(),
            title: Some("Jarvis rmcp resource test".into()),
            icons: None,
            website_url: None,
        },
