...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [jarvis_core::protocol::PatchApplyBeginEvent]
    /// and [jarvis_core::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [jarvis_core::protocol::ExecCommandBeginEvent]
    /// and [jarvis_core::protocol::ExecCommandEndEvent].
    pub call_id: String,
