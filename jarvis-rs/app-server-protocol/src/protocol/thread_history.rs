...
use jarvis_protocol::protocol::AgentReasoningEvent;
use jarvis_protocol::protocol::AgentReasoningRawContentEvent;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `Jarvis-rs/core/rollout/policy.rs`.
    ...
    fn handle_item_completed(&mut self, payload: &ItemCompletedEvent) {
        if let jarvis_protocol::items::TurnItem::Plan(plan) = &payload.item {
...
mod tests {
    use super::*;
    use jarvis_protocol::protocol::AgentMessageEvent;
    use jarvis_protocol::protocol::AgentReasoningEvent;
    use jarvis_protocol::protocol::AgentReasoningRawContentEvent;
    use jarvis_protocol::protocol::ThreadRolledBackEvent;
