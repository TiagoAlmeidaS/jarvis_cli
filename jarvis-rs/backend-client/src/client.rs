...
use anyhow::Result;
use jarvis_core::auth::JarvisAuth;
...
impl Client {
    ...
    pub fn from_auth(base_url: impl Into<String>, auth: &JarvisAuth) -> Result<Self> {
    ...
    fn headers(&self) -> HeaderMap {
        ...
        if let Some(ua) = &self.user_agent {
            ...
            h.insert(USER_AGENT, HeaderValue::from_static("Jarvis-cli"));
        }
    ...
    pub async fn get_rate_limits(&self) -> Result<RateLimitSnapshot> {
        let url = match self.path_style {
            PathStyle::CodexApi => format!("{}/api/Jarvis/usage", self.base_url),
    ...
    pub async fn list_tasks(
        ...
        let url = match self.path_style {
            PathStyle::CodexApi => format!("{}/api/Jarvis/tasks/list", self.base_url),
    ...
    pub async fn get_task_details_with_body(
        ...
        let url = match self.path_style {
            PathStyle::CodexApi => format!("{}/api/Jarvis/tasks/{}", self.base_url, task_id),
    ...
    pub async fn list_sibling_turns(
        ...
        let url = match self.path_style {
            PathStyle::CodexApi => format!(
                "{}/api/Jarvis/tasks/{}/turns/{}/sibling_turns",
    ...
    /// Fetch the managed requirements file from Jarvis-backend.
    ///
    /// `GET /api/Jarvis/config/requirements` (Jarvis API style) or
    ...
    pub async fn get_config_requirements_file(&self) -> Result<ConfigFileResponse> {
        let url = match self.path_style {
            PathStyle::CodexApi => format!("{}/api/Jarvis/config/requirements", self.base_url),
    ...
    pub async fn create_task(&self, request_body: serde_json::Value) -> Result<String> {
        let url = match self.path_style {
            PathStyle::CodexApi => format!("{}/api/Jarvis/tasks", self.base_url),
