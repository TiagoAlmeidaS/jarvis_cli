...
use jarvis_core::config::ConstraintResult;
use jarvis_core::config::types::Notifications;
use jarvis_core::features::FEATURES;
use jarvis_core::features::Feature;
use jarvis_core::git_info::current_branch_name;
use jarvis_core::git_info::local_git_branches;
use jarvis_core::models_manager::manager::ModelsManager;
use jarvis_core::project_doc::DEFAULT_PROJECT_DOC_FILENAME;
use jarvis_core::protocol::AgentMessageDeltaEvent;
use jarvis_core::protocol::AgentMessageEvent;
use jarvis_core::protocol::AgentReasoningDeltaEvent;
use jarvis_core::protocol::AgentReasoningEvent;
use jarvis_core::protocol::AgentReasoningRawContentDeltaEvent;
...
use jarvis_core::protocol::McpStartupCompleteEvent;
use jarvis_core::protocol::McpStartupStatus;
use jarvis_core::protocol::McpStartupUpdateEvent;
use jarvis_core::protocol::McpToolCallBeginEvent;
use jarvis_core::protocol::McpToolCallEndEvent;
use jarvis_core::protocol::Op;
use jarvis_core::protocol::PatchApplyBeginEvent;
use jarvis_core::protocol::RateLimitSnapshot;
use jarvis_core::protocol::ReviewRequest;
use jarvis_core::protocol::ReviewTarget;
use jarvis_core::protocol::SkillMetadata as ProtocolSkillMetadata;
use jarvis_core::protocol::StreamErrorEvent;
use jarvis_core::protocol::TerminalInteractionEvent;
use jarvis_core::protocol::TokenUsage;
use jarvis_core::protocol::TokenUsageInfo;
use jarvis_core::protocol::TurnAbortReason;
use jarvis_core::protocol::TurnCompleteEvent;
use jarvis_core::protocol::TurnDiffEvent;
use jarvis_core::protocol::UndoCompletedEvent;
use jarvis_core::protocol::UndoStartedEvent;
use jarvis_core::protocol::UserMessageEvent;
use jarvis_core::protocol::ViewImageToolCallEvent;
use jarvis_core::protocol::WarningEvent;
use jarvis_core::protocol::WebSearchBeginEvent;
use jarvis_core::protocol::WebSearchEndEvent;
...
use jarvis_protocol::config_types::CollaborationModeMask;
...
use jarvis_protocol::models::local_image_label_text;
...
use chrono::Local;
use jarvis_common::approval_presets::ApprovalPreset;
...
use jarvis_protocol::openai_models::InputModality;
use jarvis_protocol::openai_models::ModelPreset;
...
const NUDGE_MODEL_SLUG: &str = "gpt-5.1-Jarvis-mini";
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) feedback: jarvis_feedback::CodexFeedback,
...
fn rate_limit_error_kind(info: &JarvisErrorInfo) -> Option<RateLimitErrorKind> {
    match info {
        JarvisErrorInfo::ModelCap {
            model,
            reset_after_seconds,
        ...
        JarvisErrorInfo::UsageLimitExceeded => Some(RateLimitErrorKind::UsageLimit),
        JarvisErrorInfo::ResponseTooManyFailedAttempts {
...
/// and by sending requests back to Jarvis-core.
///
...
pub(crate) struct ChatWidget {
    ...
    /// Tracks whether Jarvis-core currently considers an agent turn to be in progress.
    ///
    ...
    feedback: jarvis_feedback::CodexFeedback,
...
impl ChatWidget {
    ...
    fn on_session_configured(&mut self, event: jarvis_core::protocol::SessionConfiguredEvent) {
        self.bottom_pane
        ...
        // Ask Jarvis-core to enumerate custom prompts for this session.
    ...
    fn on_thread_name_updated(&mut self, event: jarvis_core::protocol::ThreadNameUpdatedEvent) {
    ...
    fn on_patch_apply_end(&mut self, event: jarvis_core::protocol::PatchApplyEndEvent) {
        let ev2 = event.clone();
        self.defer_or_handle(
    ...
    fn on_get_history_entry_response(
        &mut self,
        event: jarvis_core::protocol::GetHistoryEntryResponseEvent,
    ) {
        let jarvis_core::protocol::GetHistoryEntryResponseEvent {
            offset,
            log_id,
            entry,
        } = event;
    ...
    pub(crate) fn handle_patch_apply_end_now(
        &mut self,
        event: jarvis_core::protocol::PatchApplyEndEvent,
    ) {
    ...
    pub(crate) fn new(common: ChatWidgetInit, thread_manager: Arc<ThreadManager>) -> Self {
        ...
        let jarvis_op_tx = spawn_agent(config.clone(), app_event_tx.clone(), thread_manager);
    ...
    pub(crate) fn new_from_existing(
        common: ChatWidgetInit,
        conversation: std::sync::Arc<jarvis_core::JarvisThread>,
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::ElevateSandbox => {
                #[cfg(target_os = "windows")]
                {
                    ...
                    self.otel_manager.counter(
                        "Jarvis.windows_sandbox.setup_elevated_sandbox_command",
                        1,
                        &[],
                    );
                    self.app_event_tx
            ...
            SlashCommand::Logout => {
                if let Err(e) = jarvis_core::auth::logout(
    ...
    fn dispatch_command_with_args(
        ...
        match cmd {
            SlashCommand::Rename if !trimmed.is_empty() => {
                ...
                let Some(name) = jarvis_core::util::normalize_thread_name(&prepared_args) else {
    ...
    fn dispatch_event_msg(&mut self, id: Option<String>, msg: EventMsg, from_replay: bool) {
        ...
        match msg {
            ...
            EventMsg::Error(ErrorEvent {
                ...
                if let Some(info) = jarvis_error_info
            ...
            EventMsg::ItemCompleted(event) => {
                if let jarvis_protocol::items::TurnItem::Plan(plan_item) = event.item {
    ...
    fn on_entered_review_mode(&mut self, review: ReviewRequest, from_replay: bool) {
        ...
        let hint = review
            .user_facing_hint
            .unwrap_or_else(|| jarvis_core::review_prompts::user_facing_hint(&review.target));
    ...
    fn prefetch_rate_limits(&mut self) {
        ...
        if !self
            ...
            .auth_cached()
            .as_ref()
            .is_some_and(JarvisAuth::is_chatgpt_auth)
        {
            return;
        }
    ...
    fn open_personality_popup_for_current_model(&mut self) {
        ...
        header.push(Line::from(
            "Choose a communication style for Jarvis. Disable in /experimental.".dim(),
        ));
    ...
    fn is_auto_model(model: &str) -> bool {
        model.starts_with("Jarvis-auto-")
    }

    fn auto_model_order(model: &str) -> usize {
        match model {
            "Jarvis-auto-fast" => 0,
            "Jarvis-auto-balanced" => 1,
            "Jarvis-auto-thorough" => 2,
            _ => 3,
        }
    }
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        let header = self.model_menu_header(
            ...
            "Access legacy models by running Jarvis -m <model_name> or in your config.toml",
        );
        self.bottom_pane.show_selection_view(SelectionViewParams {
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-Jarvis")
            || preset.model.starts_with("gpt-5.1-Jarvis-max")
    ...
    fn open_approval_mode_popup(&mut self, include_read_only: bool) {
        ...
        let show_elevate_sandbox_hint = jarvis_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED
        ...
        for preset in presets.into_iter() {
            ...
            let actions: Vec<SelectionAction> = if requires_confirmation {
                ...
                #[cfg(target_os = "windows")]
                {
                    ...
                    {
                        let preset_clone = preset.clone();
                        if jarvis_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED
                            && jarvis_core::windows_sandbox::sandbox_setup_is_complete(
                                self.config.jarvis_home.as_path(),
                            )
                        {
                            vec![Box::new(move |tx| {
    ...
    pub(crate) fn world_writable_warning_details(&self) -> Option<(Vec<String>, usize, bool)> {
        ...
        match jarvis_windows_sandbox::apply_world_writable_scan_and_denies(
            self.config.jarvis_home.as_path(),
            cwd.as_path(),
            &env_map,
            self.config.sandbox_policy.get(),
            Some(self.config.jarvis_home.as_path()),
        ) {
            Ok(_) => None,
    ...
    pub(crate) fn open_full_access_confirmation(
        ...
        let info_line = Line::from(vec![
            "When Jarvis runs with full access, it can edit any file on your computer and run commands with network, without your approval. "
                .into(),
    ...
    pub(crate) fn open_windows_sandbox_enable_prompt(&mut self, preset: ApprovalPreset) {
        ...
        if !jarvis_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED {
            ...
            header.push(*Box::new(
                Paragraph::new(vec![
                    ...
                    line!["Learn more: https://developers.openai.com/Jarvis/windows"],
                ])
        ...
        self.otel_manager
            .counter("Jarvis.windows_sandbox.elevated_prompt_shown", 1, &[]);
        ...
        stay_actions.insert(
            ...
            Box::new({
                ...
                move |_tx| {
                    otel.counter("Jarvis.windows_sandbox.elevated_prompt_decline", 1, &[]);
                }
            }),
        );
        ...
        let items = vec![
            SelectionItem {
                ...
                description: None,
                actions: vec![Box::new(move |tx| {
                    accept_otel.counter("Jarvis.windows_sandbox.elevated_prompt_accept", 1, &[]);
    ...
    pub(crate) fn open_windows_sandbox_fallback_prompt(
        ...
        lines.push(line![
            "Learn more: https://developers.openai.com/Jarvis/windows"
        ]);
        ...
        stay_actions.insert(
            ...
            Box::new({
                let otel = self.otel_manager.clone();
                move |_tx| {
                    otel.counter("Jarvis.windows_sandbox.fallback_stay_current", 1, &[]);
                }
            }),
        );
        let items = vec![
            SelectionItem {
                ...
                actions: vec![Box::new({
                    ...
                    move |tx| {
                        otel.counter("Jarvis.windows_sandbox.fallback_retry_elevated", 1, &[]);
                        tx.send(AppEvent::BeginWindowsSandboxElevatedSetup {
                            preset: preset.clone(),
                        });
                    }
            ...
            SelectionItem {
                ...
                actions: vec![Box::new({
                    ...
                    move |tx| {
                        otel.counter("Jarvis.windows_sandbox.fallback_use_legacy", 1, &[]);
                        tx.send(AppEvent::EnableWindowsSandboxForAgentMode {
                            preset: preset.clone(),
                            mode: WindowsSandboxEnableMode::Legacy,
                        });
    ...
    fn rename_confirmation_cell(name: &str, thread_id: Option<ThreadId>) -> PlainHistoryCell {
        let resume_cmd = jarvis_core::util::resume_command(Some(name), thread_id)
            .unwrap_or_else(|| format!("Jarvis resume {name}"));
        ...
        for connector in connectors {
            ...
            let (selected_label, missing_label, instructions) = if connector.is_accessible {
                ...
                (
                    ...
                    "Install this app in your browser, then reload Jarvis.",
                )
            };
    ...
    /// Forward an `Op` directly to Jarvis.
    pub(crate) fn submit_op(&mut self, op: Op) {
        ...
        if let Err(e) = self.jarvis_op_tx.send(op) {
    ...
    pub(crate) async fn show_review_commit_picker(&mut self, cwd: &Path) {
        let commits = jarvis_core::git_info::recent_commits(cwd, 100).await;
...
async fn fetch_rate_limits(base_url: String, auth: JarvisAuth) -> Option<RateLimitSnapshot> {
...
pub(crate) fn show_review_commit_picker_with_entries(
    chat: &mut ChatWidget,
    entries: Vec<jarvis_core::git_info::CommitLogEntry>,
) {
