...
use jarvis_core::default_client::create_client;
...
pub fn get_upgrade_version(config: &Config) -> Option<String> {
    ...
    info.and_then(|info| {
        if is_newer(&info.latest_version, jarvis_CLI_VERSION).unwrap_or(false) {
...
const HOMEBREW_CASK_URL: &str =
    "https://raw.githubusercontent.com/Homebrew/homebrew-cask/HEAD/Casks/c/Jarvis.rb";
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/Jarvis/releases/latest";
...
fn version_filepath(config: &Config) -> PathBuf {
    config.jarvis_home.join(VERSION_FILENAME)
}
