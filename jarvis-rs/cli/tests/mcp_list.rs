...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = jarvis_command(jarvis_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(jarvis_home.path()).await?;
    ...
    let mut list_cmd = jarvis_command(jarvis_home.path())?;
    ...
    let mut list_json_cmd = jarvis_command(jarvis_home.path())?;
    ...
    let mut get_cmd = jarvis_command(jarvis_home.path())?;
    ...
    assert!(stdout.contains("remove: Jarvis mcp remove docs"));

    let mut get_json_cmd = jarvis_command(jarvis_home.path())?;
    get_json_cmd
