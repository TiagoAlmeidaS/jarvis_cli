...
use jarvis_core::landlock::spawn_command_under_linux_sandbox;
#[cfg(target_os = "macos")]
...
pub async fn run_command_under_seatbelt(
    ...
    _jarvis_linux_sandbox_exe: Option<PathBuf>,
) -> anyhow::Result<()> {
...
async fn run_command_under_sandbox(
    ...
    if let SandboxType::Windows = sandbox_type {
        #[cfg(target_os = "windows")]
        {
            ...
            let base_dir = config.jarvis_home.clone();
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let jarvis_linux_sandbox_exe = config
                .jarvis_linux_sandbox_exe
                .expect("Jarvis-linux-sandbox executable not found");
