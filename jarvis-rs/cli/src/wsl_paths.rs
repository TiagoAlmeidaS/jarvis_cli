...
pub use jarvis_core::env::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\Jarvis.zip").as_deref(),
            Some("/mnt/c/Temp/Jarvis.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/Jarvis.tgz").as_deref(),
            Some("/mnt/d/Work/Jarvis.tgz")
        );
        assert!(win_path_to_wsl("/home/user/Jarvis").is_none());
    }
