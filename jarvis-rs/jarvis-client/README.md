...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any jarvis/OpenAI awareness.
...
- Consumed by higher-level crates like `jarvis-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
