use crate::default_client::JarvisHttpClient;
use crate::default_client::JarvisRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: JarvisHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<JarvisRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
