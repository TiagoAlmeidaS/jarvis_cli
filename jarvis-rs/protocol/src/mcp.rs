...
//! `schemars`) so they can be embedded in Jarvis's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `Jarvis-protocol` so other crates can convert
