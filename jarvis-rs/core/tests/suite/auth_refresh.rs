...
use jarvis_core::auth::REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR;
use jarvis_core::auth::RefreshTokenError;
use jarvis_core::auth::load_auth_dot_json;
...
impl RefreshTokenTestContext {
    ...
    fn load_auth(&self) -> Result<AuthDotJson> {
        load_auth_dot_json(self.jarvis_home.path(), AuthCredentialsStoreMode::File)
