...
use jarvis_core::X_RESPONSESAPI_INCLUDE_TIMING_METRICS_HEADER;
...
const MODEL: &str = "gpt-5.2-Jarvis";
...
async fn websocket_harness_with_runtime_metrics(
    ...
    let metrics = MetricsClient::new(
        MetricsConfig::in_memory("test", "Jarvis-core", env!("CARGO_PKG_VERSION"), exporter)
            .with_runtime_reader(),
    )
