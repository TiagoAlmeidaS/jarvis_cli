...
use jarvis_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            jarvis_linux_sandbox_exe: turn_ctx.jarvis_linux_sandbox_exe.as_ref(),
        ...
        match tool.run(req, &initial_attempt, tool_ctx).await {
            ...
            Err(ToolError::Jarvis(JarvisErr::Sandbox(SandboxErr::Denied { output }))) => {
                if !tool.escalate_on_failure() {
                    return Err(ToolError::Jarvis(JarvisErr::Sandbox(SandboxErr::Denied {
                        output,
                    })));
                }
