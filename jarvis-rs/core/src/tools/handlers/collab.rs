...
use jarvis_protocol::protocol::CollabAgentInteractionBeginEvent;
use jarvis_protocol::protocol::CollabAgentInteractionEndEvent;
use jarvis_protocol::protocol::CollabAgentSpawnBeginEvent;
use jarvis_protocol::protocol::CollabAgentSpawnEndEvent;
use jarvis_protocol::protocol::CollabCloseBeginEvent;
use jarvis_protocol::protocol::CollabCloseEndEvent;
use jarvis_protocol::protocol::CollabWaitingBeginEvent;
use jarvis_protocol::protocol::CollabWaitingEndEvent;
    ...
    pub async fn handle(
        ...
        for id in &receiver_thread_ids {
            match session.services.agent_control.subscribe_status(*id).await {
                ...
                Err(JarvisErr::ThreadNotFound(_)) => {
...
fn collab_spawn_error(err: JarvisErr) -> FunctionCallError {
    match err {
...
fn collab_agent_error(agent_id: ThreadId, err: JarvisErr) -> FunctionCallError {
    match err {
        JarvisErr::ThreadNotFound(id) => {
...
fn build_agent_spawn_config(
    ...
    config.jarvis_linux_sandbox_exe = turn.jarvis_linux_sandbox_exe.clone();
...
mod tests {
    ...
    async fn build_agent_spawn_config_uses_turn_context_values() {
        ...
        turn.jarvis_linux_sandbox_exe = Some(PathBuf::from("/bin/echo"));
        ...
        expected.jarvis_linux_sandbox_exe = turn.jarvis_linux_sandbox_exe.clone();
