# `jarvis-core` config loader

This module is the canonical place to **load and describe jarvis configuration layers** (user config, CLI/session overrides, managed config, and MDM-managed preferences) and to produce:
