...
pub async fn spawn_command_under_seatbelt(
    ...
    let arg0 = None;
    env.insert(jarvis_SANDBOX_ENV_VAR.to_string(), "seatbelt".to_string());
    spawn_child_async(
...
mod tests {
    ...
    fn create_seatbelt_args_with_read_only_git_and_codex_subpaths() {
        ...
        // top-level .git and .jarvis directories and one without them.
        ...
        // write to .jarvis/config.toml in the vulnerable root.
        ...
        // - write access to WRITABLE_ROOT_0 (but not its .git or .jarvis), WRITABLE_ROOT_1, and cwd as WRITABLE_ROOT_2.
...
"#,
        ...
        // Verify that .jarvis/config.toml cannot be modified under the generated
        // Seatbelt policy.
        ...
        // Verify that writing a file to the folder containing .git and .jarvis is allowed.
    ...
    fn create_seatbelt_args_for_cwd_as_git_repo() {
        ...
        // `.jarvis` checks are done properly for cwd.
        let policy = SandboxPolicy::WorkspaceWrite {
            writable_roots: vec![],
            network_access: false,
...
"#,
    ...
    struct PopulatedTmp {
        /// Path containing a .git and .jarvis subfolder.
        ...
        /// ran `git commit` themselves, or modified .jarvis/config.toml to
        ...
        /// Path without .git or .jarvis subfolders.
        empty_root: PathBuf,
    ...
    fn populate_tmpdir(tmp: &Path) -> PopulatedTmp {
        ...
        fs::create_dir_all(vulnerable_root.join(".jarvis")).expect("create .jarvis");
        fs::write(
            vulnerable_root.join(".jarvis").join("config.toml"),
            "sandbox_mode = \"read-only\"\n",
        )
        .expect("write .jarvis/config.toml");
        ...
        let dot_codex_canonical = vulnerable_root_canonical.join(".jarvis");
