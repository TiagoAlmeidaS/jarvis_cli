...
pub struct IdTokenInfo {
    ...
    /// Email verification status (Google OAuth)
    pub email_verified: Option<bool>,
    /// User identifier (sub claim from Google/OAuth provider)
    pub sub: Option<String>,
    /// User's full name (Google OAuth)
    pub name: Option<String>,
    /// User's profile picture URL (Google OAuth)
