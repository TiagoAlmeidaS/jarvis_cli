...
use crate::spawn::jarvis_SANDBOX_NETWORK_DISABLED_ENV_VAR;
use crate::tools::sandboxing::SandboxablePreference;
use jarvis_protocol::config_types::WindowsSandboxLevel;
pub use jarvis_protocol::models::SandboxPermissions;
...
pub(crate) enum SandboxTransformError {
    #[error("missing Jarvis-linux-sandbox executable path")]
...
impl SandboxManager {
    ...
    pub(crate) fn select_initial(
        ...
        match pref {
            ...
            SandboxablePreference::Require => {
                ...
                crate::safety_legacy::get_platform_sandbox(
            ...
            SandboxablePreference::Auto => match policy {
                ...
                _ => crate::safety_legacy::get_platform_sandbox(
                    windows_sandbox_level != WindowsSandboxLevel::Disabled,
                )
                .unwrap_or(SandboxType::None),
            },
    ...
    pub(crate) fn transform(
        ...
        if !policy.has_full_network_access() {
            env.insert(
                jarvis_SANDBOX_NETWORK_DISABLED_ENV_VAR.to_string(),
                "1".to_string(),
            );
        }
        ...
        let (command, sandbox_env, arg0_override) = match sandbox {
            ...
            SandboxType::MacosSeatbelt => {
                ...
                seatbelt_env.insert(jarvis_SANDBOX_ENV_VAR.to_string(), "seatbelt".to_string());
                let mut args =
            ...
            SandboxType::LinuxSeccomp => {
                let exe = jarvis_linux_sandbox_exe
                ...
                (
                    full_command,
                    HashMap::new(),
                    Some("Jarvis-linux-sandbox".to_string()),
                )
            }
            // On Windows, the restricted token sandbox executes in-process via the
            // Jarvis-windows-sandbox crate. We leave the command unchanged here and
