...
#[cfg(test)]
mod tests {
    use jarvis_api::ResponsesApiRequest;
    use jarvis_api::common::OpenAiVerbosity;
    use jarvis_api::common::TextControls;
    ...
    fn serializes_text_schema_with_strict_format() {
        ...
        assert_eq!(
            format.get("name"),
            Some(&serde_json::Value::String("jarvis_output_schema".into()))
        );
        assert_eq!(
            format.get("type"),
