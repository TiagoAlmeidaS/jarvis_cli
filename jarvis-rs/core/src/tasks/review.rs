...
use jarvis_protocol::protocol::AgentMessageContentDeltaEvent;
use jarvis_protocol::protocol::AgentMessageDeltaEvent;
use jarvis_protocol::protocol::Event;
use jarvis_protocol::protocol::EventMsg;
use jarvis_protocol::protocol::ExitedReviewModeEvent;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        let _ = session
            ...
            .services
            .otel_manager
            .counter("Jarvis.task.review", 1, &[]);

        // Start sub-Jarvis conversation and get the receiver for events.
