...
pub enum Feature {
    ...
    PowershellUtf8,
    /// Compress request bodies (zstd) when sending streaming requests to Jarvis-backend.
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://github.com/openai/Jarvis/blob/main/docs/config.md#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW! Try shell snapshotting to make your Jarvis faster. Enable in /experimental!",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Sub-agents",
            menu_description: "Ask Jarvis to spawn multiple agents to parallelize the work and win in efficiency.",
            announcement: "NEW: Sub-agents can now be spawned by Jarvis. Enable in /experimental and restart Jarvis!",
        },
        default_enabled: false,
    },
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Apps",
            menu_description: "Use a connected ChatGPT App using \"$\". Install Apps via /apps command. Restart Jarvis after enabling.",
            announcement: "NEW: Use ChatGPT Apps (Connectors) in Jarvis via $ mentions. Enable in /experimental and restart Jarvis!",
        },
        default_enabled: false,
    },
    FeatureSpec {
