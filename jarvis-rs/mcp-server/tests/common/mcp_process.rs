...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = jarvis_utils_cargo_bin::cargo_bin("Jarvis-mcp-server")
            .context("should find binary for Jarvis-mcp-server")?;
    ...
    pub async fn initialize(&mut self) -> anyhow::Result<()> {
        ...
        let originator = jarvis_core::default_client::originator().value;
    ...
    pub async fn send_codex_tool_call(
        ...
        let jarvis_tool_call_params = CallToolRequestParam {
            name: "Jarvis".into(),
        ...
        self.send_request(
            "tools/call",
            Some(serde_json::to_value(jarvis_tool_call_params)?),
        )
        .await
    }
    ...
    /// Method "Jarvis/event" with params.msg.type == "task_complete".
        ...
        loop {
            ...
            match message {
                JsonRpcMessage::Notification(notification) => {
                    let is_match = if notification.notification.method == "Jarvis/event" {
